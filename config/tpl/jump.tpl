...
<head>
	...
	<title>跳转提示</title>
	<link rel="stylesheet" href="<?php echo(config('site_root'));?>/static/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="<?php echo(config('site_root'));?>/static/amazeui/assets/css/amazeui.min.css">
	<style type="text/css">
		html {
			height:100%;
		}
